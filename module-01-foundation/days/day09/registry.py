...
acc3 = AccountFactory.create("savings", "Dawit", 1003, 1000)
acc4 = AccountFactory.create("current", "Meron", 1003, 70000)

Megenagna.add_accounts(acc1)
Megenagna.add_accounts(acc2)
Bole.add_accounts(acc3)

print("Total Balance", Head_office.total_balance())
print ("Reachable: ", bfs(transfers, "CBE-1"))